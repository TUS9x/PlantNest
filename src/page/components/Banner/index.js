import { Image, Box, Stack, Card, CardBody, Heading, Button } from '@chakra-ui/react';
        ...
        <>
            ...
            <Card direction="row" overflow="hidden" variant="outline" borderStyle="none">
                <Stack width={{ base: '40%', sm: '50%' }}>
                    <CardBody>
                        <Heading fontFamily={'inherit'} fontSize={{ base: '3xl', sm: '6xl' }} fontWeight="normal" paddingTop="5rem">
                            Best house <br />
                            plants varieties
                        </Heading>
                        <br />
